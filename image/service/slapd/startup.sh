...
LDAP_TLS_CA_CRT_PATH="${LDAP_TLS_CA_CRT_PATH:-${CONTAINER_SERVICE_DIR}/slapd/assets/certs/$LDAP_TLS_CA_CRT_FILENAME}"
LDAP_TLS_CRT_PATH="${LDAP_TLS_CRT_PATH:-${CONTAINER_SERVICE_DIR}/slapd/assets/certs/$LDAP_TLS_CRT_FILENAME}"
LDAP_TLS_KEY_PATH="${LDAP_TLS_KEY_PATH:-${CONTAINER_SERVICE_DIR}/slapd/assets/certs/$LDAP_TLS_KEY_FILENAME}"
LDAP_TLS_DH_PARAM_PATH="${LDAP_TLS_DH_PARAM_PATH:-${CONTAINER_SERVICE_DIR}/slapd/assets/certs/$LDAP_TLS_DH_PARAM_FILENAME}"
...
EOF
  ...
  if [ "${KEEP_EXISTING_CONFIG,,}" == "true" ]; then
    ...
    if [ "${LDAP_TLS,,}" == "true" ]; then
      ...
      [ -f ${LDAP_TLS_KEY_PATH} ] || ssl-helper $LDAP_SSL_HELPER_PREFIX $LDAP_TLS_CRT_PATH $LDAP_TLS_KEY_PATH $LDAP_TLS_CA_CRT_PATH
